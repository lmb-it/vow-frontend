...
const Group = ({
  ...
  return /* @__PURE__ */ jsxs(
    Flex,
    {
      ...
      children: [
        label && /* @__PURE__ */ jsx("div", { style: elStyles.header || void 0, children: /* @__PURE__ */ jsx(Divider, { align: "left", children: /* @__PURE__ */ jsx(Label, { className: "font-bold text-lg", label, elementId: element.id.toString() }) }) }),
