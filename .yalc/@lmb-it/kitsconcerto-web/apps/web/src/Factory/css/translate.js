import { generateResponsiveObject } from './responsive.js';
...
const generateGridStyles = (props) => {
  ...
  if (colSpan != null) {
    props.colSpan = generateResponsiveObject("colSpan", colSpan, toSpanValue);
  }
  if (rowSpan != null) {
    props.rowSpan = generateResponsiveObject("rowSpan", rowSpan, toSpanValue);
  }
  return props;
};

export { generateGridStyles, translateCss };
