...
const TreeViewToolbar = ({
  ...
  const startContent = /* @__PURE__ */ jsxRuntime.jsx(index.default, { flexDirection: "row", gap: 4, alignItems: "center", w: "full", justifyContent: "space-between", children: /* @__PURE__ */ jsxRuntime.jsx(
    index_web.default,
    {
      leftAddon: /* @__PURE__ */ jsxRuntime.jsx("i", { className: "pi pi-search" }),
      id: "tree-view-filter",
      value: filterValue,
      onChange: (e) => {
  ...
  const centerContent = /* @__PURE__ */ jsxRuntime.jsxs(index.default, { flexDirection: "row", gap: 4, children: [
    ...
    !!serverSide?.listFetcher && /* @__PURE__ */ jsxRuntime.jsx(
      Button_web.Button,
      {
        type: "button",
        icon: "pi pi-refresh",
  ...
  const endContent = /* @__PURE__ */ jsxRuntime.jsxs(
    index.default,
    {
      w: "full",
      ...
      gap: 4,
      children: [
        (!hideDisabledButton && !categoryButton || categoryButton) && /* @__PURE__ */ jsxRuntime.jsx(
          Button_web.Button,
          {
            type: "button",
            icon: "pi pi-plus",
        ...
        (!hideDisabledButton && !itemButton || itemButton) && /* @__PURE__ */ jsxRuntime.jsx(
          Button_web.Button,
          {
            type: "button",
            severity: "secondary",
        ...
        (!hideDisabledButton && !deleteButton || deleteButton) && /* @__PURE__ */ jsxRuntime.jsx(
          Button_web.Button,
          {
            type: "button",
            severity: "danger",
        ...
        (!hideDisabledButton && !editButton || editButton) && /* @__PURE__ */ jsxRuntime.jsx(
          Button_web.Button,
          {
            type: "button",
            severity: "secondary",
