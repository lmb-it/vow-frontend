...
import { useRef, useState, useCallback, useEffect, useImperativeHandle, useMemo, createContext, useContext, Fragment } from 'react';
import useSWR from 'swr';
import moment from 'moment';
import { isEqual } from 'lodash';
import { DataView as DataView$1, DataViewLayoutOptions } from 'primereact/dataview';
import { ProgressSpinner } from 'primereact/progressspinner';
import { Divider } from 'primereact/divider';
import Pagination from './Pagination/index.web.js';
...
const DataView = (props) => {
  ...
  const itemTemplate = (item, layout2, index) => {
    ...
    return /* @__PURE__ */ jsx(Fragment, { children: layout2 == "list" ? listItem(item, index) : gridItem(item, index) }, item[keyColumn]);
  };
  const listTemplate = (items, layout2) => {
    return /* @__PURE__ */ jsx(Flex, { flexDirection: layout2 == "list" ? "column" : "row", gap: 15, className: `${layout2} ${layout2}-nogutter`, children: items.map((item, index) => itemTemplate(item, layout2, index)) });
  };
  ...
  const header = () => {
    return /* @__PURE__ */ jsxs(Flex, { className: "p-dataview-header", w: "full", children: [
      !hideModeButtons && /* @__PURE__ */ jsx("div", { className: "flex justify-content-end", children: /* @__PURE__ */ jsx(
      ...
      filtersFormElements && /* @__PURE__ */ jsxs(Flex, { gap: "1.25rem", w: "full", children: [
        /* @__PURE__ */ jsx(Flex, { w: "full", children: /* @__PURE__ */ jsx(
          Form,
          {
            ref: filterFormRef,
  ...
  return /* @__PURE__ */ jsx(
    DataViewContext.Provider,
    {
      ...
      children: /* @__PURE__ */ jsxs(Flex, { flexDirection: "column", id: "data-view", children: [
        isHeader && header(),
        isHeader && /* @__PURE__ */ jsx(Divider, {}),
        /* @__PURE__ */ jsxs(
          Flex,
          {
            ...
            children: [
              ...
              isLoading && !pagination && /* @__PURE__ */ jsx(Flex, { w: "full", justifyContent: "center", alignItems: "center", children: /* @__PURE__ */ jsx(ProgressSpinner, { style: { width: 35 } }) })
            ]
          }
        )
      ] })
